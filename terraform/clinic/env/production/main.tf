terraform {
  ...
  backend "s3" {
    ...
    key            = "app/production/avixo2-clinic.tfstate"
...
module "avixo2-clinic" {
  ...
  secret_name                = "web/avixo2-clinic/production"
  kms_key_alias              = "alias/avixo2-clinic-production"
