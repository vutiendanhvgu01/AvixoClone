terraform {
  ...
  backend "s3" {
    ...
    key            = "app/staging/avixo2-clinic.tfstate"
...
module "avixo2-clinic" {
  ...
  secret_name                = "web/avixo2-clinic/staging"
  kms_key_alias              = "alias/avixo2-clinic-staging"
  ...
  domain_name                = "staging.clinic.avixo.co"
