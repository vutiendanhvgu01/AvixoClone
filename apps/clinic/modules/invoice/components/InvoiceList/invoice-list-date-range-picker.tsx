...
interface InvoicesListDateRangePickerProps {
  onDateRangeSelected: (dateRange: DateRange<Date>) => void;
}

const InvoicesListDateRangePicker: React.FC<InvoicesListDateRangePickerProps> = ({ onDateRangeSelected }) => {
...
export default InvoicesListDateRangePicker;
