...
const touchPositionToArray = ({ clientX, clientY }: { clientX: number; clientY: number }): Point => {
  return [clientX, clientY];
};

export const getTouchPosition = (event: MouseOrTouchEvent<HTMLCanvasElement>): Point => {
