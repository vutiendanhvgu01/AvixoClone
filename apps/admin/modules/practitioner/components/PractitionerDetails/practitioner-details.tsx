...
import { InformationLineProps } from 'common/components/InformationCard/information-card-types';
...
import { Email, Language, Phone, Practitioner } from '../../types/practitioner';
...
const PractitionerDetails: React.FC<PractitionerDetailsProps> = ({ practitioner, organisation, premise }) => {
